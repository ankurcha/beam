...
public class BigtableIO {
  ...
  public static class Read extends PTransform<PBegin, PCollection<Row>> {
    ...
    public Read withBigtableOptions(BigtableOptions.Builder optionsBuilder) {
      ...
      BigtableOptions clonedOptionsWithAgent = options.toBuilder()
              .setDataChannelCount(1)
              .setUserAgent(getUserAgent())
              .build();

      return new Read(clonedOptionsWithAgent, tableId, keyRange, filter, bigtableService);
    }
      ...
      BigtableOptions clonedOptionsWithAgent = options.toBuilder()
          ...
          .setBulkOptions(
              options.getBulkOptions().toBuilder()
                  ...
                  .build())
              .build();
      return new Write(clonedOptionsWithAgent, tableId, bigtableService);
    }
